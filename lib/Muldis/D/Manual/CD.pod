...
This document is Muldis::D::Manual::CD version 0.8.0.
...
=head2 PTMD_STD - the_database
    ...
    Muldis_D:"http://muldis.com":0.136.0:PTMD_STD:{
...
=head2 HDMD_Perl6_STD - the_database
    ...
    [
        [ 'Muldis_D', 'http://muldis.com', '0.136.0', 'HDMD_Perl6_STD', {
            catalog_abstraction_level => 'rtn_inv_alt_syn',
            op_char_repertoire => 'basic'
        } ],
...
=head2 HDMD_Perl5_STD - the_database
    ...
    [
        [ 'Muldis_D', 'http://muldis.com', '0.136.0', 'HDMD_Perl5_STD', {
            catalog_abstraction_level => 'rtn_inv_alt_syn',
            op_char_repertoire => 'basic'
        } ],
